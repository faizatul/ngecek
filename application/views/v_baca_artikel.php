            ...
            <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                <div class="single-blog wow fadeIn">
                    ...
                    <div class="post-thumbnail">
                        <img src="<?php echo base_url().'assets/img/blog/'.$artikel->gambar?>" alt="">
                    </div>
                    <div class="blog-details">
                        <div class="title-and-meta">
                            <h3><a href="kesalahan-orang-tua-dalam-memberikan-disiplin-kepada-anak.html"><?php echo $artikel->judul_artikel ?></a></h3>
                            <p class="post-meta">By <a href="#">Admin</a> | <a href="#"><?php echo $artikel->tgl_input;?></a></p>
                        </div>
                ...
                <div class="tags-and-social-bar wow fadeIn">
                    ...
                    <div class="tags">
                        <h3>TAGS:</h3>
                        <ul>
                            <li><a href="<?php echo base_url().'baca/kategori/2'?>">Children</a></li>
                            <li><a href="<?php echo base_url().'baca/kategori/3'?>">Parents</a></li>
                            <li><a href="<?php echo base_url().'baca/kategori/1'?>">Love</a></li>
                        </ul>
                    </div>
                ...
                <div class="blog-comments wow fadeIn">
                    ...
                    <div class="single-comments">
                        <div class="comment-author-img alignleft">
                            <img src="img/blog/thumb_1.jpg" alt="">
                        </div>
                        <div class="comment-details">
                            <div class="comment-meta">
                                <h5>Pietter<span><a href="#"><i class="fa fa-arrow-left"></i>Replay</a></span></h5>
                    ...
                    <div class="single-comments">
                        <div class="comment-author-img alignleft">
                            <img src="img/blog/thumb_2.jpg" alt="">
                        </div>
                        <div class="comment-details">
                            <div class="comment-meta">
                                <h5>Admin <span><a href="#"><i class="fa fa-arrow-left"></i>Replay</a></span></h5>
                                <p class="comment-date-count"><a href="#">2 days ago</a></p>
                            </div>
                            <p>Take up one idea. Make that one idea your life - think of it, dream of it, live on that idea. Let the brain, muscles, nerves, every part of your body, be full of that idea.</p>
                        </div>
                    ...
                    <div class="single-comments">
                        <div class="comment-author-img alignleft">
                            <img src="img/blog/thumb_3.jpg" alt="">
                        </div>
                        <div class="comment-details">
                            <div class="comment-meta">
                                <h5>Nado<span><a href="#"><i class="fa fa-arrow-left"></i>Replay</a></span></h5>
                                <p class="comment-date-count"><a href="#">2 days ago</a></p>
                            </div>
                            <p>Take up one idea. Make that one idea your life - think of it, dream of it, live on that idea. Let the brain, muscles, nerves, every part of your body, be full of that idea.</p>
                        </div>
